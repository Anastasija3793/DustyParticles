#############################################################################
# Makefile for building: DustyParticles
# Generated by qmake (3.1) (Qt 5.8.0)
# Project:  DustyParticles.pro
# Template: app
# Command: /home/abelaka/Qt/5.8/gcc_64/bin/qmake -o Makefile DustyParticles.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I. -isystem /usr/include/libdrm -I../../Qt/5.8/gcc_64/include -I../../Qt/5.8/gcc_64/include/QtGui -I../../Qt/5.8/gcc_64/include/QtCore -I. -I../../Qt/5.8/gcc_64/mkspecs/linux-clang
QMAKE         = /home/abelaka/Qt/5.8/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = DustyParticles1.0.0
DISTDIR = /home/abelaka/Documents/DustyParticles/obj/DustyParticles1.0.0
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -Wl,-rpath,/home/abelaka/Qt/5.8/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -lSDL2 -lGLU -lSDL2_image -L/usr/local/lib/ -lGL -L/home/abelaka/Qt/5.8/gcc_64/lib -lQt5Gui -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: DustyParticles.pro ../../Qt/5.8/gcc_64/mkspecs/linux-clang/qmake.conf ../../Qt/5.8/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.8/gcc_64/mkspecs/common/unix.conf \
		../../Qt/5.8/gcc_64/mkspecs/common/linux.conf \
		../../Qt/5.8/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt/5.8/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile DustyParticles.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/particle.h src/environment.h src/Vec4.h src/Mat4.h src/emitter.h $(DISTDIR)/
	$(COPY_FILE) --parents src/Main.cpp src/particle.cpp src/environment.cpp src/Vec4.cpp src/Mat4.cpp src/emitter.cpp $(DISTDIR)/
...
moc_predefs.h: ../../Qt/5.8/gcc_64/mkspecs/features/data/dummy.cpp
	clang++ -pipe -std=c++11 -g -std=gnu++11 -Wall -W -dM -E -o moc_predefs.h ../../Qt/5.8/gcc_64/mkspecs/features/data/dummy.cpp
...
obj/environment.o: src/environment.cpp src/environment.h \
		src/particle.h \
		src/Vec4.h
